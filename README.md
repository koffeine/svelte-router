...
[`main.js`](https://github.com/koffeine/svelte-router/blob/master/src/main.js):
...
[`App.svelte`](https://github.com/koffeine/svelte-router/blob/master/src/App.svelte):
...
[`Welcome.svelte`](https://github.com/koffeine/svelte-router/blob/master/src/Welcome.svelte):
